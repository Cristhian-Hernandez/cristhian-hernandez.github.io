...
r=function(){dpi=window.devicePixelRatio;var a='data-src'; if($('.js').hasAttr('src')) { a='src'; } $('.js').attr(a, (dpi>1) ? 'images/logo-400-6.png' : 'images/logo-200-6.png');
var a='data-src'; if($('.js-7').hasAttr('src')) { a='src'; } $('.js-7').attr(a, (dpi>1) ? 'images/bb4239c89c284350-1200-6.jpg' : 'images/bb4239c89c284350-600-6.jpg');};
